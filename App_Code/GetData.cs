...
public class GetData
{
    ...
    {
        //Connection String
        conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["IDASurat"].ConnectionString);
        conn1 = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["IDASurat"].ConnectionString);
    }
    ...
    public void ExecuteQueryBySP(SqlCommand cmd)
    {
        try
        {
            SqlCommand cm = cmd;
    ...
    public Int32 ExecuteQueryBySpWithReturn(SqlCommand cmd)
    {
        try
        {
            SqlCommand cm = cmd;
            ...
            conn.Open();
            cm.ExecuteNonQuery();
            Int32 id = Convert.ToInt32(cmd.Parameters["@paymentid"].Value.ToString());
            conn.Close();
            return id;
        }
        catch (System.Data.SqlClient.SqlException ex)
