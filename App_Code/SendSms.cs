...
public class SendSms
{
    ...
    public string sendotp(string Vmessage, string Vmobno)
    {
        ...
        //HttpWebRequest req = (HttpWebRequest)WebRequest.Create("http://bulksms.itfuturz.com/api/sendmsg.php?user=leonad&pass=dns123&sender=LEONAD&phone=" + Vmobno + "&text=" + Vmessage + "&priority=ndnd&stype=normal");
        HttpWebRequest req = (HttpWebRequest)WebRequest.Create("http://promosms.itfuturz.com/vendorsms/pushsms.aspx?user=idasur&password=dns123&msisdn=" + Vmobno + "&sid=IDASUR&msg=" + Vmessage + "&fl=0&gwid=2");
