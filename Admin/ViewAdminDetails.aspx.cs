...
public partial class Admin_ViewAdminDetails : System.Web.UI.Page
{
    ...
    private void LoadPieGraph()
    {
        ...
        else if (ddlSelect.SelectedValue == "2")
        {
            ...
            qry = "select (SELECT Count(*) FROM InquiryMaster WHERE InquiryDate between '" + txtFrom.Text + "' and '" + txtTo.Text + "' and Status=1) as ct1,(SELECT Count(*) FROM InquiryMaster WHERE InquiryDate between '" + txtFrom.Text + "' and '" + txtTo.Text + "' and Status=0) as ct2";
        }
