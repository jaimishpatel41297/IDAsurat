<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OperatorMaster.master" AutoEventWireup="true" CodeFile="ChangePassworduser.aspx.cs" Inherits="Admin_ChangePassworduser" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <asp:TextBox runat="server" ID="txtoldpass" TextMode="Password" CssClass="typeahead form-control" Placeholder="Enter Old Password" ValidationGroup="AddEmployee"></asp:TextBox>
                                </div>
