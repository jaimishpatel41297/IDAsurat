<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewAdminAttendance.aspx.cs" Inherits="Admin_ViewAdminAttendance" %>
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="text-left" style="margin-left: 1%;">
                                    ...
                                    <asp:LinkButton Style="margin-left: 1%;" runat="server" ID="IbView" ValidationGroup="AddEmployee" OnClick="IbView_Click" CssClass="fcbtn btn btn-success btn-outline btn-1d waves-effect">View Attendance Graph</asp:LinkButton>
                                </div>
