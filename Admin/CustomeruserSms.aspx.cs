...
public partial class Admin_CustomeruserSms : System.Web.UI.Page
{
    ...
    private void BindData1()
    {
        ...
        try
        {
            string qry = "select im.*,c.Title as CName from InquiryMaster im, Course c where im.CourseId=c.Id and Status=1 and UserId='" + id + "'   order by id desc";
    ...
    {
        string id = cookie.Value.ToString();
        string qry = "select im.*,c.Title as CName from InquiryMaster im, Course c where im.CourseId=c.Id and Status=0 and UserId='" + id + "'  order by id desc";
