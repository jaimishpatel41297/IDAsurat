...
public partial class Admin_ViewAdminInquiryDone : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            {
                qry = "select distinct im.*,c.Title as CName,cm.Amount as Amount,r.Name as RName from InquiryMaster im, CourseMaster cm,Course c,Reference r where im.CourseId=c.Id and im.CourseId=cm.Courseid and im.Refid=r.Id and Status=0 and UserId='" + id + "' order by id desc";
            }
