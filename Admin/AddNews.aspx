<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddNews.aspx.cs" Inherits="Admin_AddNews" %>
                            ...
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table-responsive table table-striped table-bordered" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Banner Image">
                                        <ItemTemplate>
                                            <img src='<%# Eval("Image") %>' alt="Image" style="height: 200px; width: 200px;">
                                        </ItemTemplate>
                                    </asp:TemplateField>
