...
<head runat="server">
    ...
    <title>IDA Surat Admin Panel</title>
    <link rel="icon" href="plugins/images/ida_logo.png" sizes="32x32" />
            ...
            <form class="login-form" runat="server">
                <div class="row">
                    <div class="input-field col s12 center">
                        <img src="plugins/images/ida_logo.png" alt="" class="responsive-img valign profile-image-login" />
                        <p class="center login-form-text">IDA Surat</p>
                    </div>
                </div>
                ...
                <div class="row margin">
                 ...
                 <div class="row margin">
                    <div class="input-field col s12">
                        ...
                        <label for="dropdown" class="center-align">Select Category</label>
                    </div>
                </div>
