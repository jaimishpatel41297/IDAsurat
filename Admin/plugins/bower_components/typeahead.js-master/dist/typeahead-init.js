...
var countries = new Bloodhound({
    ...
    prefetch: 'Admin/plugins/bower_components/typeahead.js-master/countries.json'
});
...
var nflTeams = new Bloodhound({
    ...
    prefetch: 'Admin/plugins/bower_components/typeahead.js-master/nfl.json'
});
...
var nbaTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: 'Admin/plugins/bower_components/typeahead.js-master/nba.json'
});

var nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: 'Admin/plugins/bower_components/typeahead.js-master/nhl.json'
});
