<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Viewincomegraph.aspx.cs" Inherits="Admin_Viewincomegraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <%--                   <div class="col-sm-12" id="months" runat="server" visible="false" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-12" id="fromto" runat="server" visible="true">
                        <div class="col-sm-4">
                            <label for="">
                                From
                    ...
                    <div style="margin-top: 45px; margin-left: 16px;">
                        <asp:LinkButton runat="server" ID="lbSubmit" ValidationGroup="AddEmployee" OnClick="lbSubmit_Click" CssClass="fcbtn btn btn-success btn-outline btn-1d waves-effect" Visible="true">Submit</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
