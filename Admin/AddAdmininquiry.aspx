<%@ Page Title="" EnableEventValidation="true" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddAdmininquiry.aspx.cs" Inherits="Admin_AddAdmininquiry" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">
                            ...
                            <div class="text-right">
                                <asp:LinkButton runat="server" ID="lbSubmit" ValidationGroup="AddEmployee" OnClick="lbSubmit_Click" CommandArgument='<%# Eval("Id") %>' CssClass="fcbtn btn btn-success btn-outline btn-1d waves-effect">Submit</asp:LinkButton>
                ...
                <div class="modal-content" style="width: 84%; margin-left: 70px;">
                        ...
                        <ContentTemplate>
                            <div class="modal-body">
                                <div class="form-group" style="margin-bottom: 40px;">
                                    <label for="">
                                        Course
                                     <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddDetails" ControlToValidate="ddlcourse1" ID="RequiredFieldValidator13" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                     </asp:RequiredFieldValidator>
                                    </label>
                                    <div>
                    ...
                    <div class="modal-footer" style="margin-top: 70px;">
                        <div class="text-right">
                            ...
                            <asp:LinkButton runat="server" ID="LinkButton1" ValidationGroup="AddDetails" OnClick="lbUpdate_Click" Visible="false" CssClass="fcbtn btn btn-primary btn-outline btn-1d waves-effect" CommandArgument='<%# Eval("Id") %>'>Update</asp:LinkButton>
