<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewAdminattendancegraph.aspx.cs" Inherits="Admin_ViewAdminattendancegraph" %>
     ...
     <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">View Attendance Graph</h4>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="white-box">
                    ...
                    <div style="margin-top: 45px; margin-left: 16px;">
                        <asp:LinkButton style="margin-top: 1%;" runat="server" ID="lbSubmit" ValidationGroup="AddEmployee" OnClick="lbSubmit_Click" CssClass="fcbtn btn btn-success btn-outline btn-1d waves-effect" Visible="false">Submit</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="white-box">
                    <div style="margin-top: 110px; margin-left: 16px;">
                        <asp:Literal ID="ltrAttGraph" runat="server"></asp:Literal>
                    </div>
                </div>
            </div>
        </div>
