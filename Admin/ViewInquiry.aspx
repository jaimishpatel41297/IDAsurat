<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OperatorMaster.master" AutoEventWireup="true" CodeFile="ViewInquiry.aspx.cs" Inherits="Admin_ViewFollowup" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="text-right">
                        ...
                        <asp:LinkButton runat="server" ID="lbCancel" data-dismiss="modal" CssClass="fcbtn btn btn-danger btn-outline btn-1d waves-effect" OnClick="lbCancel_Click1">Cancel</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
