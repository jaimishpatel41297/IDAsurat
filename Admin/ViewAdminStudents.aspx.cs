...
public partial class Admin_ViewAdminStudents : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            {
                qry = "select distinct im.*,c.Title as CName,cm.Amount as Amount,r.Name as RName from InquiryMaster im,Course c, CourseMaster cm,Reference r where im.CourseId=c.Id and im.CourseId=cm.Courseid and im.Refid=r.Id and im.CourseId='" + ddlcourse.SelectedValue + "' and Status=1";
            }
            else
            {
                qry = "select distinct im.*,c.Title as CName,cm.Amount as Amount,r.Name as RName from InquiryMaster im,Course c, CourseMaster cm,Reference r where im.CourseId=c.Id and im.CourseId=cm.Courseid and im.Refid=r.Id and Status=1";
            }
