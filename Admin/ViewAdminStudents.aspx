<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewAdminStudents.aspx.cs" Inherits="Admin_ViewAdminStudents" %>
                ...
                <div class="modal-content" style="height: 738px; width: 555px; margin-left: 6%;">
                    ...
                    <div class="text-right">
                        <div class="modal-footer" style="margin-top: 120px;">
                            ...
                            <asp:LinkButton runat="server" ID="lbCancel" data-dismiss="modal" OnClick="lbCancel_Click"></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
