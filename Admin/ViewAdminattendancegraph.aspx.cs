...
public partial class Admin_ViewAdminattendancegraph : System.Web.UI.Page
{
    ...
    private void LoadattendanceGraph()
    {
        ...
        if (ddlSelect.SelectedValue == "1")
        {
            ...
            qry = "select (SELECT Count(*) FROM Attendance WHERE MONTH(Date) = " + ddlMonth.SelectedValue + " and Attendance='P') as ct1,(SELECT Count(*) FROM Attendance WHERE  MONTH(Date) = " + ddlMonth.SelectedValue + " and Attendance='A') as ct2";
        }
        else if (ddlSelect.SelectedValue == "2")
        {
            ...
            qry = "select (SELECT Count(*) FROM Attendance WHERE Date between '" + txtFrom.Text + "' and '" + txtTo.Text + "' and Attendance='P') as ct1,(SELECT Count(*) FROM Attendance WHERE Date between '" + txtFrom.Text + "' and '" + txtTo.Text + "' and Attendance='A') as ct2";
        }
        ...
        strChart += "<html>" + Environment.NewLine +
                   ...
                   "text: 'Attendance Detail'" + Environment.NewLine +
                   "}," + Environment.NewLine +
        ...
        {
            strChart += "['Present'," + dtGraph.Rows[0][0].ToString() + "]," + Environment.NewLine + "['Absent'," + dtGraph.Rows[0][1].ToString() + "]," + Environment.NewLine;
        }
